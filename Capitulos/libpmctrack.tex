...
La estrcuctura del capítulo consiste en las siguientes secciones. La sección 3.1 explica las razones que motivaban la implementación de libpmctrack a partir de necesidades no cubiertas previamente mediante la herramienta PMCTrack. En la sección 3.2 hablamos del funcionamiento de la librería y comentamos sus potencialidades de uso, también dentro de esta sección aparece una subsección hablando de cómo usamos libpmctrack para refactorizar todo el código de la herramienta de línea de comandos \texttt{pmctrack}. Por último, en la sección 3.3 exponemos y describimos la API de la librería, tanto su interfaz básica como su otra interfaz más avanzada.
