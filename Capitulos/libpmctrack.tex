...
\todo{En la figura \ref{fig:ejlibpmctrack} podemos ver un pequeño ejemplo de uso de esta librería con todos los pasos mencionados previamente. "pmc0,pmc3=0xc4",NULL//instr + branch instr}
