...
\todo{
\begin{figure}
\caption{Ejemplo de uso de la interfaz básica de libpmctrack}
...
int main(int argc, char *argv[])
{
    ...
    char* strcfg[]={"pmc1=0x11,pmc2=0x08",NULL};
#else
    char* strcfg[]={"pmc0,pmc1,pmc2,pmc3=0x2e,umask3=0x4f,pmc4=0x2e,umask4=0x41",NULL};
#endif
    char* virtual_cfg=NULL; //"virt0";

    /* Initialize the thread descriptor */
    if (pmctrack_init(&desc,20))
        exit(1);

    /* Configure counters */
    if (pmctrack_config_counters(&desc,strcfg,virtual_cfg,100))
        exit(1);
...
\todo{En la figura \ref{fig:ejlibpmctrack} podemos ver un pequeño ejemplo de uso de esta librería con todos los pasos mencionados previamente.}
