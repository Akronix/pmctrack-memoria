...
La configuración para la monitorización se hace pasando un \textit{string} con la configuración para cada \ac{PMC} o contador hardware y, opcionalmente, los \glosstex{contadores virtuales} que se quieren utilizar.
