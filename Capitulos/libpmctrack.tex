...
Finalmente, la función \texttt{pmctrack_destroy()} cerrará los ficheros que quedasen abiertos y liberará la memoria reservada para el buffer.
...
\begin{description}
  ...
  Abre fichero /proc/pmc/monitor para lectura.
