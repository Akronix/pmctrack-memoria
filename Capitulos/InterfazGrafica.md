...
\begin{resumen}
Este capítulo habla sobre PMCTrack-GUI, una aplicación que permite la visualización de gráficas de rendimiento en tiempo real de aplicaciones de usuario, usando la herramienta de línea de comandos \texttt{pmctrack} para obtener los datos de monitorización. Se empezará a hablar de la motivación del desarrollo de esta aplicación, pasando a describir sus ventajas y características, su modo de uso y finalmente, detalles de su diseño.
\end{resumen}
