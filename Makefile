...
NOMBRE_LATEX = Memoria
MAIN_TEX=$(NOMBRE_LATEX).tex
...
MD_FILES=$(wildcard Capitulos/*.md)
TEXMD_FILES = $(addsuffix .tex, $(basename $(MD_FILES)))

.PHONY: notes pdf_notes clean default

.SUFFIXES: .md .tex .html .pdf
...
# usando pandoc y fichero adicional talk.tex
.md.tex: $(MAIN_TEX)
	pandoc $< -t latex  | iconv -f utf-8 -t iso-8859-1 > $@
