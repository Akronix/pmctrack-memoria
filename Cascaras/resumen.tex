...
Nuestro proyecto ha consistido en la ampliación de la herramienta PMCTrack para el kernel Linux, cuyo fin
...
\emph{Palabras clave}: Monitorización rendimiento, Monitorización hardware, Contadores hardware, Kernel Linux, Análisis código fuente, Aplicaciones multihilo, Monitorización de la memoria caché.
