...
Por último, la última fase de mi estudio de documentación se corresponde con mis contribuciones de más bajo nivel: Implementación conjunta del soporte \textit{multithreading} y Diseño e implementación de libpmtrack, apartados \ref{app:contr_abel_mult} y \ref{app:contr_abel_lib} respectivamente.\newline
...
Con este diseño ya planteado, Jorge y yo realizamos diversas jornadas de trabajo conjuntas para la implementación completa de esta parte del proyecto. Posteriormente, realizamos un conjunto de pruebas mediante la herramienta \texttt{pmctrack}, usando benchmarks de \ref{JORGE-PON-AQUÍ-NOMBRE-DE-BENCHMARKS} y contrastamos sus resultados con otras fuentes para verificar si eran correctas.
