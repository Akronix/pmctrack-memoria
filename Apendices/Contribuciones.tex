...
Por último, la última fase de mi estudio de documentación se corresponde con las contribuciones de más bajo nivel: ``Implementación conjunta del soporte \textit{multithreading}'' y ``Diseño e implementación de libpmtrack'', apartados \ref{app:contr_abel_mult} y \ref{app:contr_abel_lib} respectivamente.\newline
